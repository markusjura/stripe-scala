...
== This fork supports API version 2013-11-14

== Quickstart with sbt 0.12.2
...
== Installation
The current release is distributed for <b>Scala 2.10.0 or later</b>. Add +stripe-scala+ as a dependency in sbt or Maven:

=== sbt
Add the stripe-scala dependency:

    val stripeScala = "com.stripe" %% "stripe-scala" % “1.2.0”
